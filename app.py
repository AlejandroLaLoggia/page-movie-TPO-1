...
app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+mysqlconnector://root:1010@localhost:3306/suscripciones' 
...
@app.route("/")
def index():
    return f'App Web para registrar suscripciones de personas'
...
@app.route("/templates/personas",  methods=['GET'])
def personas():
